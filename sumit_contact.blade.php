...
@php $link = mysql_connect("localhost","root","");
	...
	mysql_select_db("computerclub");
        ...
        $strSQL1 = "INSERT INTO contact (Username,Name,Subject,Massage) VALUES ('".$objResult["Username"]."', 
		'".$objResult["Name"]."','".$_POST["subject"]."','".$_POST["text"]."')";
		$insert = mysql_query($strSQL1);
                  
        echo "<BR><BR><CENTER><BR><BR><H1>Complete !</H1></CENTER>";
        sleep(5);



	mysql_close($link); @endphp
<script type='text/javascript'>window.location='contact.php';</script>
   <div class="clear"></div>
