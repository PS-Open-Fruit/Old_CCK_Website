...
<div class="sidebar_content_box">
	...
	novelgames_gameID = '211';
	novelgames_gameShortName = 'busmath';
	novelgames_language = 'e';
    </script>
            <script language="JavaScript" type="text/JavaScript" src="http://www.novelgames.com/en/spgames/game.js"></script></center>
        <div class="clear"></div>
